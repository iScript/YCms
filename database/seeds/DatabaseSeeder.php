...
class UserTableSeeder extends Seeder {
    ...
    public function run(){
        ...
        $sql = "INSERT INTO `iz_user` (`id`, `username`, `nickname`, `mobile`, `email`, `password`, `register_time`, `last_login_time`, `avatar`, `sex`, `status`, `remember_token`, `created_at`, `updated_at`, `deleted_at`)
