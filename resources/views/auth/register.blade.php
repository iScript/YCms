	...
	<form class="pure-form pure-form-aligned" method="post" action="/register">
		<fieldset>
			<div class="pure-control-group">
				...
				<input id="mobile" type="text" placeholder="手机号" name="mobile">
			</div>
			...
			<div class="pure-control-group">
				...
				<input id="password" type="text" placeholder="验证码" name="verify_code"><button id="send_code" type="button">发送验证码</button>
			</div>
